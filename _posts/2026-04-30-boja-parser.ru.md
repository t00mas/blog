...
27 апреля 2026 года Официальный вестник правительства Андалусии (BOJA) опубликовал выпуск 79 C1: более 2000 страниц деклараций об активах, доходах и интересах 1129 кандидатов на выборах в региональный парламент 17 мая. Публичные данные, формально доступные любому гражданину. На практике — PDF.
...
**[→ Просмотреть декларации](https://tomaspica.com/declaraciones-andalucia-2026/)**

Код парсера и веб-приложения в репозитории, лицензия MIT. Исходные данные публичны (BOJA).
